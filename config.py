...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7757503882:AAEiIrX-uwsQK19jLhR0dWc00E0H3kZQPsQ")
...
#--------------------------------------------
REDIRECT_BASE_URL = os.environ.get("REDIRECT_BASE_URL", "https://kgnbotz.blogspot.com/2025/07/anireal.html")
